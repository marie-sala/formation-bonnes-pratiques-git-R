...
::: {.incremental}
Lors de la création du projet sur `Gitlab`, un fichier `.gitignore` a été créé, qui se situe à la racine du projet. Il spécifie l'ensemble des fichiers qui seront toujours exclus de l'indexation faite par `Git`.
