...
3. Créer une copie locale (clone) du projet sur `RStudio`
4. Créer un fichier `<votre_nom>-<votre_prenom>.md`. Écrire dedans trois phrases de son choix, puis `commit` et `push` les modifications
